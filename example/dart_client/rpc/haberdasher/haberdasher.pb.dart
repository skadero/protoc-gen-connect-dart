...
import '../pinger/ping.pb.dart' as $0;

class Hat extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Hat', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'haberdasher'), createEmptyInstance: create)
...
class Size extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Size', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'haberdasher'), createEmptyInstance: create)
...
class HaberdasherApi {
  ...
  $async.Future<$0.PingResponse> ping($pb.ClientContext? ctx, $0.PingRequest request) {
    ...
    return _client.invoke<$0.PingResponse>(ctx, 'Haberdasher', 'Ping', request, emptyResponse);
  }
  $async.Future<$0.PingResponse> invalidArg($pb.ClientContext? ctx, $0.PingRequest request) {
    var emptyResponse = $0.PingResponse();
    return _client.invoke<$0.PingResponse>(ctx, 'Haberdasher', 'InvalidArg', request, emptyResponse);
  }
}
